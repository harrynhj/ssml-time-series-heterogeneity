...
def load_all_data(data_path,batch_size,nbatches,mode='train'):
    ...
    if mode =='val':
        data_mode = 'train'
    data_reader = reader.LengthOfStayReader(dataset_dir=os.path.join(data_path, data_mode),
    ...
    normalizer_state = 'los_ts{}.input_str-previous.start_time-zero.n5e4.normalizer'.format(1.0)
